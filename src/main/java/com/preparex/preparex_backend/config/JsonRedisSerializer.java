...
/**
 * Custom Redis serializer that uses a pre-configured ObjectMapper for JSON serialization.
 * Avoids deprecated Spring Data Redis serializer APIs.
 */
public class JsonRedisSerializer implements RedisSerializer<Object> {
    ...
    public Object deserialize(byte[] bytes) throws SerializationException {
        ...
        try {
            ...
            throw new SerializationException("Error deserializing JSON to object: "
